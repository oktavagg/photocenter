...
<body>
    <form>
        <h2 style="margin: 10px 0;"><?= $_SESSION['user']['full_name'] ?> (Головний адміністратор)</h2>
...
<script>
        function openFolder() {
            window.open('D:/ospanel/domains/localhost');
